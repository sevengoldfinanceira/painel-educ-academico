...
const FAIND_INDIARA_POS_GRADUACAO_COURSES = [
  ...
  "ADMINISTRAÇÃO PÚBLICA",
  "ANÁLISE CLÍNICAS E BIOTECNOLOGIA",
  "ANÁLISE CLÍNICAS E MICROBIOLOGIA",
  "ANÁLISE DO COMPORTAMENTO APLICADA AO DESENVOLVIMENTO NEUROTÍPICO",
  ...
  "CENTRO CIRÚRGICO E CENTRO DE MATERIAIS",
  "CIÊNCIA DA RELIGIÃO",
  "CIÊNCIA POLÍTICA",
  "CIÊNCIAS DA ALIMENTAÇÃO",
  "CIÊNCIAS NEUROLÓGICAS, DEFICIÊNCIAS MÚLTIPLAS E SURDOCEGUEIRA",
  "CLÍNICA GERAL E TERAPIA INTENSIVA",
  "CLÍNICA MÉDICA E CIRÚRGICA DE CÃES E GATOS",
  "COMÉRCIO EXTERIOR",
  "COMPETÊNCIAS E HABILIDADES EDUCACIONAIS NO PROTAGONISMO JUVENIL",
  "CONHECIMENTOS PEDAGÓGICOS DA EDUCAÇÃO",
  ...
  "DIREITO PENAL",
  "DIREITO PENAL COM ÊNFASE EM PSICOLOGIA E CRIMINOLOGIA",
  "DIREITO PENAL E PROCESSUAL PENAL",
  "DIREITO PREVIDENCIÁRIO",
  "DIREITO PROCESSUAL CIVIL",
  "DIREITO TRIBUTÁRIO",
  "DIREITOS HUMANOS E RESSOCIALIZAÇÃO",
  "DIREITOS HUMANOS, DIVERSIDADE E QUESTÕES ÉTNICO-SOCIAIS OU RACIAIS",
  "DOCÊNCIA DO ENSINO DA TEOLOGIA",
  "DOCÊNCIA DO ENSINO SUPERIOR",
  "DOCÊNCIA DO ENSINO SUPERIOR E INSPEÇÃO ESCOLAR",
  "DOCÊNCIA DO ENSINO SUPERIOR E NEUROPSICOLOGIA",
  "DOCÊNCIA DO ENSINO SUPERIOR E PSICOMOTRICIDADE",
  ...
  "EDUCAÇÃO À DISTÂNCIA: GESTÃO E TUTORIA",
  ...
  "EDUCAÇÃO ESPECIAL E ENSINO RELIGIOSO",
  ...
  "ENGENHARIA DE ESTRUTURAS DE CONCRETO ARMADO",
  "ENGENHARIA DE PAVIMENTAÇÃO ASFÁLTICA",
  "ENGENHARIA DE PRODUÇÃO",
  ...
  "ENGENHARIA ELÉTRICA",
  "ENGENHARIA ELÉTRICA COM ÊNFASE EM INSTALAÇÕES ELÉTRICAS INDUSTRIAIS",
  "ENGENHARIA ELÉTRICA COM ÊNFASE EM INSTALAÇÕES RESIDENCIAIS",
  "ENGENHARIA ELÉTRICA COM ÊNFASE EM SISTEMAS DE AUTOMAÇÃO",
  "ENGENHARIA ELETRÔNICA E ELETROMECÂNICA",
  ...
  "ESTIMULAÇÃO PRECOCE NA INFÂNCIA",
  "ESTUDOS LINGUÍSTICOS E LITERÁRIOS",
  "FILOSOFIA E DIREITOS HUMANOS",
  "FILOSOFIA E SOCIOLOGIA",
  "FINANÇAS E ESTATÍSTICA",
  "FINANÇAS E MATEMÁTICA",
  "FÍSICA E ÉTICA APLICADA À SAÚDE",
  "FÍSICA ESCOLAR E TGD",
  ...
  "GESTÃO EDUCACIONAL",
  "GESTÃO DE ENFERMAGEM DE URGÊNCIA E EMERGÊNCIA",
  "GESTÃO DE EQUIPES",
  ...
  "GESTÃO HOSPITALAR",
  "GESTÃO PÚBLICA",
  "GESTÃO PÚBLICA E DE PESSOAS",
  "GOVERNANÇA EM TECNOLOGIA DA INFORMAÇÃO",
  "HEMATOLOGIA",
  "HIGIENE E INSPEÇÃO DE PRODUTOS DE ORIGEM ANIMAL",
  "GOVERNANÇA EM TI",
  "HIGIENE OCUPACIONAL",
  "HISTÓRIA DAS CULTURAS AFRO E INDÍGENA",
  ...
  "LÍNGUA LATINA E FILOLOGIA ROMÂNTICA",
  ...
  "LUDOPEDAGOGIA E PSICOPEDAGOGIA INSTITUCIONAL",
  "LUDOPEDAGOGIA E TGD",
  "MASSOTERAPIA",
  ...
  "MBA EM GASTRONOMIA",
  "MBA EM GESTÃO DE PROJETOS EDUCACIONAIS E NEGÓCIOS EMPRESARIAIS",
  "MEDICINA DO TRABALHO",
  "MEDICINA VETERINÁRIA DO COLETIVO",
  "MEIO AMBIENTE, DESENVOLVIMENTO E SUSTENTABILIDADE",
  "METODOLOGIA DO ENSINO DA LÍNGUA ALEMÃ",
  "METODOLOGIA DO ENSINO DAS LÍNGUAS INGLESA E ESPANHOLA",
  "METODOLOGIA DO ENSINO DAS LÍNGUAS PORTUGUESA E ESPANHOLA",
  "METODOLOGIA DO ENSINO DAS LÍNGUAS PORTUGUESA E INGLESA",
  ...
  "METODOLOGIA DO ENSINO FUNDAMENTAL E MÉDIO COM ÊNFASE EM ARTES",
  "METODOLOGIA DO ENSINO FUNDAMENTAL E MÉDIO COM ÊNFASE EM BIOLOGIA",
  "METODOLOGIA DO ENSINO FUNDAMENTAL E MÉDIO COM ÊNFASE EM EDUCAÇÃO INFANTIL E ANOS INICIAIS",
  "METODOLOGIA DO ENSINO FUNDAMENTAL E MÉDIO COM ÊNFASE EM GEOGRAFIA E ESTUDOS AMAZÔNICOS",
  "METODOLOGIA DO ENSINO FUNDAMENTAL E MÉDIO COM ÊNFASE EM LÍNGUA PORTUGUESA E LITERATURA",
  "METODOLOGIA DO ENSINO FUNDAMENTAL E MÉDIO COM ÊNFASE EM MATEMÁTICA",
  "METODOLOGIA DOS ESPORTES COLETIVOS",
  "MOBILIDADE HUMANA",
  "NEUROCIÊNCIA E APRENDIZAGEM",
  "NEURODESENVOLVIMENTO ATÍPICO E PRÁTICAS EDUCACIONAIS NA INCLUSÃO",
  "NEUROPSICOLOGIA",
  "NEUROPSICOLOGIA CLÍNICA E REABILITAÇÃO NEUROPSICOLÓGICA",
  "NEUROPSICOPEDAGOGIA",
  ...
  "PSICOPEDAGOGIA CLÍNICA, INSTITUCIONAL E TGD",
  ...
  "SAÚDE COLETIVA",
  "SAÚDE DA FAMÍLIA",
  "SAÚDE DA MULHER, DO IDOSO E GERONTOLOGIA",
...
function normalizeData(data) {
  ...
  mergeFaindIndiaraPosGraduacaoCourses(data);
...
function mergeFaindIndiaraPosGraduacaoCourses(data) {
  if (data.imports.faindIndiaraPosGraduacaoV1) return;
  ...
  FAIND_INDIARA_POS_GRADUACAO_COURSES.forEach((name, index) => {
    const key = `${normalize(name)}|${normalize("Pos-graduacao")}`;
    if (existingCourseNames.has(key)) return;
    data.courses.push({
      id: `faind-indiara-pos-graduacao-${index + 1}`,
      partnerId: partner.id,
      name,
      type: "Nível Master",
      modality: "Pos-graduacao",
      ...
      examFileName: "",
      examDataUrl: "",
      notes: "Faculdade Faind Faculdade de Indiara. Pós-graduação lato sensu.",
    });
    existingCourseNames.add(key);
  });

  data.imports.faindIndiaraPosGraduacaoV1 = true;
}
